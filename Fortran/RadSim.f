...
double precision, parameter :: mu            = 4 * pi * (10 ** -7);      ! [Tm/A]

double precision, parameter :: dTheta        = .001 / pi                 ! radians
double precision, parameter :: delt          = 10 ** -6                  ! seconds
